...
// ------------------------------------------------------------
 ...
 public const int NOUN_ru = 9;                     // class СУЩЕСТВИТЕЛЬНОЕ
 public const int PRONOUN2_ru = 10;                // class МЕСТОИМ_СУЩ
 public const int PRONOUN_ru = 11;                 // class МЕСТОИМЕНИЕ
 public const int ADJ_ru = 12;                     // class ПРИЛАГАТЕЛЬНОЕ
 public const int NUMBER_CLASS_ru = 13;            // class ЧИСЛИТЕЛЬНОЕ
 public const int INFINITIVE_ru = 14;              // class ИНФИНИТИВ
 public const int VERB_ru = 15;                    // class ГЛАГОЛ
 public const int GERUND_2_ru = 16;                // class ДЕЕПРИЧАСТИЕ
 public const int PREPOS_ru = 17;                  // class ПРЕДЛОГ
 public const int IMPERSONAL_VERB_ru = 18;         // class БЕЗЛИЧ_ГЛАГОЛ
 public const int PARTICLE_ru = 21;                // class ЧАСТИЦА
 public const int CONJ_ru = 22;                    // class СОЮЗ
 public const int ADVERB_ru = 23;                  // class НАРЕЧИЕ
 public const int PUNCTUATION_class = 24;          // class ПУНКТУАТОР
...
// Coordiname ВРЕМЯ states:
 ...
 public const int VOICE_ru = 23;                   // enum ЗАЛОГ
// Coordiname ЗАЛОГ states:
 public const int PASSIVE_VOICE_ru = 0;            // ЗАЛОГ : СТРАД
 public const int ACTIVE_VOICE_ru = 1;             // ЗАЛОГ : ДЕЙСТВ

 public const int CASE_ru = 26;                    // enum ПАДЕЖ
...
// Coordiname ПЕРЕЧИСЛИМОСТЬ states:
 ...
 public const int COMPAR_FORM_ru = 29;             // enum СТЕПЕНЬ
// Coordiname СТЕПЕНЬ states:
 ...
 public const int CASE_GERUND_ru = 30;             // enum ПадежВал
// Coordiname ПадежВал states:

 public const int MODAL_ru = 31;                   // enum МОДАЛЬНЫЙ

 public const int VERBMODE_TENSE = 32;             // enum СГД_Время
// Coordiname СГД_Время states:

 public const int VERBMODE_DIRECTION = 33;         // enum СГД_Направление
// Coordiname СГД_Направление states:

 public const int TENSE_en = 34;                   // enum TENSE
// Coordiname TENSE states:
 ...
 public const int DURATION_en = 35;                // enum DURATION
...
// Coordiname CASE states:
 ...
 public const int NOUN_FORM_en = 38;               // enum NOUN_FORM
// Coordiname NOUN_FORM states:
 ...
 public const int PRONOUN_FORM_en = 39;            // enum PRONOUN_FORM
// Coordiname PRONOUN_FORM states:

 public const int ADJ_FORM_en = 40;                // enum ADJ_FORM
// Coordiname ADJ_FORM states:
 ...
 public const int COMPARABILITY_en = 41;           // enum COMPARABILITY
// Coordiname COMPARABILITY states:
 ...
 public const int VERB_FORM_en = 42;               // enum VERB_FORM
// Coordiname VERB_FORM states:
 ...
 public const int ARTICLE_FORM = 43;               // enum ARTICLE_FORM
// Coordiname ARTICLE_FORM states:
 ...
 public const int ENG_MODALITY = 44;               // enum ENG_MODALITY
// Coordiname ENG_MODALITY states:
 ...
 public const int NUMERAL_FORM_en = 45;            // enum NUMERAL_FORM
// Coordiname NUMERAL_FORM states:
 ...
 public const int GENDER_en = 46;                  // enum ENG_GENDER
// Coordiname ENG_GENDER states:
 ...
 public const int TRANSITIVITY_en = 47;            // enum TRANSITIVITY
// Coordiname TRANSITIVITY states:
 ...
 public const int OBLIG_TRANSITIVITY_en = 48;      // enum OBLIG_TRANSITIVITY

 public const int PROPER_NOUN_en = 49;             // enum ENG_PROPER_NOUN

 public const int MASS_NOUN_en = 50;               // enum ENG_MASS_NOUN

 public const int PERSON_fr = 51;                  // enum FR_PERSON
// Coordiname FR_PERSON states:
 ...
 public const int NUMBER_fr = 52;                  // enum FR_NOMBRE
// Coordiname FR_NOMBRE states:
 ...
 public const int GENDER_fr = 53;                  // enum FR_GENRE
// Coordiname FR_GENRE states:
 ...
 public const int FR_NUMERAL_FORM = 54;            // enum FR_NUMERAL_FORM
// Coordiname FR_NUMERAL_FORM states:
 ...
 public const int FR_PRONOUN_FORM = 55;            // enum FR_PRONOUN_FORM
// Coordiname FR_PRONOUN_FORM states:
 ...
 public const int TRANSITIVITY_fr = 56;            // enum FR_TRANSITIVITY
// Coordiname FR_TRANSITIVITY states:
 ...
 public const int VERB_FORM_fr = 57;               // enum FR_VERB_FORM
// Coordiname FR_VERB_FORM states:
 ...
 public const int JAP_FORM = 58;                   // enum JAP_FORM
// Coordiname JAP_FORM states:
 ...
 public const int JAP_VERB_BASE = 59;              // enum JAP_VERB_BASE
// Coordiname JAP_VERB_BASE states:
 ...
 public const int JAP_VERB_KIND = 60;              // enum JAP_VERB_KIND
// Coordiname JAP_VERB_KIND states:
 ...
 public const int JAP_ADJ_BASE = 61;               // enum JAP_ADJ_BASE
// Coordiname JAP_ADJ_BASE states:
 ...
 public const int JAP_ADJ_FORM2 = 62;              // enum JAP_ADJ_FORM2
// Coordiname JAP_ADJ_FORM2 states:
 ...
 public const int JAP_TRANSITIVE = 63;             // enum JAP_TRANSITIVE

 public const int CASE_jap = 64;                   // enum JAP_CASE
// Coordiname JAP_CASE states:
 ...
 public const int GENDER_jap = 65;                 // enum JAP_GENDER
// Coordiname JAP_GENDER states:
 ...
 public const int PERSON_jap = 66;                 // enum JAP_PERSON
// Coordiname JAP_PERSON states:
 ...
 public const int NUMBER_jap = 67;                 // enum JAP_NUMBER
// Coordiname JAP_NUMBER states:
 ...
 public const int JAP_PRONOUN_TYPE = 68;           // enum JAP_PRONOUN_TYPE
...
// ------------------------------------------------------------
 ...
 public const int RHEMA_link = 9;
 public const int COVERB_link = 10;
 public const int NUMBER2OBJ_link = 16;
 public const int TENSE_VERB_link = 31;
 public const int JAP_COMITATIVE_link = 33;
 public const int JAP_COMITATIVE2_link = 34;
 public const int TO_VERB_link = 35;
 public const int TO_INF_link = 36;
 public const int TO_PERFECT = 37;
 public const int TO_UNPERFECT = 38;
 public const int TO_NOUN_link = 39;
 public const int TO_ADJ_link = 40;
 public const int TO_ADV_link = 41;
 public const int TO_RETVERB = 42;
 public const int TO_GERUND_2_link = 43;
 public const int WOUT_RETVERB = 44;
 public const int TO_ENGLISH_link = 45;
 public const int TO_RUSSIAN_link = 46;
 public const int TO_FRENCH_link = 47;
 public const int SYNONYM_link = 48;
 public const int SEX_SYNONYM_link = 49;
 public const int CLASS_link = 50;
 public const int MEMBER_link = 51;
 public const int TO_SPANISH_link = 52;
 public const int TO_GERMAN_link = 53;
 public const int TO_CHINESE_link = 54;
 public const int TO_POLAND_link = 55;
 public const int TO_ITALIAN_link = 56;
 public const int TO_PORTUGUAL_link = 57;
 public const int ACTION_link = 58;
 public const int ACTOR_link = 59;
 public const int TOOL_link = 60;
 public const int RESULT_link = 61;
 public const int TO_JAPANESE_link = 62;
 public const int TO_KANA_link = 63;
 public const int TO_KANJI_link = 64;
 public const int ANTONYM_link = 65;
 public const int EXPLANATION_link = 66;
 public const int WWW_link = 67;
 public const int ACCENT_link = 68;
 public const int YO_link = 69;
 public const int TO_DIMINUITIVE_link = 70;
 public const int TO_RUDE_link = 71;
 public const int TO_BIGGER_link = 72;
 public const int TO_NEUTRAL_link = 73;
 public const int TO_SCOLARLY = 74;
 public const int TO_SAMPLE_link = 75;
 public const int USAGE_TAG_link = 76;
 public const int DOUBLE_LETTERS_link = 77;
 public const int PROPERTY_link = 78;
 public const int TO_CYRIJI_link = 79;
 public const int HABITANT_link = 80;
 public const int NGRAM_ETALON = 81;
 public const int CHILD_link = 82;
 public const int PARENT_link = 83;
 public const int UNIT_link = 84;
 public const int SET_link = 85;
 public const int TO_WEAKENED_link = 86;
 public const int SUBSTITUTION_link = 87;
 public const int VERBMODE_BASIC_link = 88;
 public const int NEGATION_PARTICLE_link = 89;
 public const int NEXT_COLLOCATION_ITEM_link = 90;
 public const int VIRTUAL_NODE_CONTENT_link = 91;
 public const int SUBORDINATE_CLAUSE_link = 92;
 public const int RIGHT_GENITIVE_OBJECT_link = 93;
 public const int ADV_PARTICIPLE_link = 94;
 public const int POSTFIX_PARTICLE_link = 95;
 public const int INFINITIVE_link = 96;
 public const int NEXT_ADJECTIVE_link = 97;
 public const int NEXT_NOUN_link = 98;
 public const int THEMA_link = 99;
 public const int RIGHT_PARTICLE_link = 100;
 public const int RIGHT_AUX2INFINITIVE_link = 101;
 public const int RIGHT_AUX2PARTICIPLE = 102;
 public const int RIGHT_AUX2ADJ = 103;
 public const int RIGHT_LOGIC_ITEM_link = 104;
 public const int RIGHT_COMPARISON_Y_link = 105;
 public const int RIGHT_NOUN_link = 106;
 public const int RIGHT_INSTR_OBJECT_link = 107;
 public const int RIGHT_DATIVE_OBJECT_link = 108;
 public const int RIGHT_NAME_link = 109;
 public const int ADJ_PARTICIPLE_link = 110;
 public const int RIGHT_ADJ_CLAUSE_link = 111;
 public const int PUNCTUATION_link = 112;
 public const int IMPERATIVE_SUBJECT_link = 113;
 public const int IMPERATIVE_VERB2AUX_link = 114;
 public const int AUX2IMPERATIVE_VERB = 115;
 public const int PREFIX_PARTICLE_link = 116;
 public const int ADRESS_TO_LISTENER_link = 117;
 public const int PREFIX_CONJUNCTION_link = 118;
 public const int LOGICAL_CONJUNCTION_link = 119;
 public const int NEXT_CLAUSE_link = 120;
 public const int LEFT_AUX_VERB_link = 121;
 public const int BEG_INTRO_link = 122;
 public const int RIGHT_PREPOSITION_link = 123;
 public const int WH_SUBJECT_link = 124;
 public const int IMPERATIVE_PARTICLE_link = 125;
 public const int GERUND_link = 126;
 public const int PREPOS_ADJUNCT_link = 127;
 public const int DIRECT_OBJ_INTENTION_link = 128;
 public const int COPULA_link = 129;
 public const int DETAILS_link = 130;
 public const int SENTENCE_CLOSER_link = 131;
 public const int OPINION_link = 132;
 public const int APPEAL_link = 133;
 public const int TERM_link = 134;
 public const int SPEECH_link = 135;
 public const int QUESTION_link = 136;
 public const int POLITENESS_link = 137;
