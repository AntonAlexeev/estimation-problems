...
extern void stem( HFAIND hEngine, const wchar_t *Word );
...
extern bool TestSyntaxAnalysis( HFAIND hEngine, const wchar_t *Phrase, bool must_be_complete_analysis );
extern bool TestLink( HFAIND hEngine, const wchar_t *Word1, int class1, const wchar_t *Word2, int class2 );


bool ProbeSpanish( HFAIND hEngine )
{
...
void Test_Spanish_Morphology( HFAIND hEngine )
{
