...
extern void Test_Russian_Morphology( HFAIND hEngine );
extern void Test_English_Morphology( HFAIND hEngine );
extern void Test_Spanish_Morphology( HFAIND hEngine );
extern void Test_French_Morphology( HFAIND hEngine );
extern void Test_Ru_En_Translation( HFAIND hEngine );
extern void Test_Ja_Ru_Translation( HFAIND hEngine );
extern void TestModifications( HFAIND hEngine );
extern bool ProbeEnglish( HFAIND hEngine );
extern bool ProbeRussian( HFAIND hEngine );
extern bool ProbeSpanish( HFAIND hEngine );
extern bool ProbeFrench( HFAIND hEngine );
...
//                _CRTDBG_CHECK_ALWAYS_DF |
 ...
 sol_ReserveLexiconSpace(hEngine,2000000);
 ...
 if( test_threads )
  ...
  {
   TestMorphologicalAnalyzer( hEngine, id_language, morph_samples, write_errors, -1 );
  }
 else if( syntax_samples!=NULL )
  {
   TestSyntacticAnalyzer( hEngine, id_language, syntax_samples, write_errors, -1 );
  }
 ...
 else
  {
   ...
   Test_Russian_Morphology(hEngine);
