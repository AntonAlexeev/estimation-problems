...
void Test_English_Morphology( HFAIND hEngine )
{
 ...
 TestSyntacticAnalyzer( hEngine, ENGLISH_LANGUAGE, "syntax-english.txt", true, -1 );
 TestMorphologicalAnalyzer( hEngine, ENGLISH_LANGUAGE, "morph-english.txt", true, -1 );
