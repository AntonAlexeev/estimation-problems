...
static bool TestTranslation( HFAIND hEngine, int icls_from, const wchar_t *word_from, int icls_to, const wchar_t *word_to )
{
 for( int j=0; j<2; ++j )
  {
...
void Test_Ru_En_Translation( HFAIND hEngine )
{
